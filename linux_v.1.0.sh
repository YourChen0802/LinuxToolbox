...
#版权信息 @YourChen Linux工具箱 v.1.0 2025年6月2日
...
network_menu() {
    ...
    echo "14. 一键测试邮件端口（25, 465, 587）是否开放"
    echo "q. 返回上级菜单"
    echo "===================="
}
...
test_ports() {
    echo "正在测试端口..."
    echo "端口25 465 587测试结果："
    ncat -zv localhost 25 && echo "端口25 465 587开放" || echo "端口25 465 587未开放"
}
